...
export const RestricoesPage = () => {
  ...
  const refreshData = async () => {
    setLoading(true);
    try {
        const [restricoesData, frotaData] = await Promise.all([
  ...
  return (
    <div className="space-y-6">
      ...
      {loading ? (
        <div className="text-center py-20 text-gray-500">Carregando restrições do SharePoint...</div>
      ) : restricoes.length === 0 ? (
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <label className="block">
                  ...
                  <input
                    ...
                    min={formData.dataParou} // HTML5 validation constraint
